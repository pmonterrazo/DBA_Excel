...
CASE 
    ...
    WHEN CAST(LEFT(CAST(B.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(B.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(B.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE) >= CURDATE() THEN 'A VENCER'

    WHEN CAST(LEFT(CAST(B.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(B.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(B.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE) < CURDATE() THEN 'VENCIDO'
...
A.CRMOVMOV_VEN AS 'VEN',

A.CRMOVMOV_SUPVD AS 'GA',
