...
FROM DBCONTROL3708005.CADMOV05 AS A
INNER JOIN DBCONTROL3708005.CADCLI01 AS B ON CAST(A.CRMOVMOV_CCLI AS VARCHAR(300))=CAST(B.VDCLICLI_REGI AS VARCHAR(300)) || REPEAT('0',4-LENGTH(CAST(B.VDCLICLI_NUM AS VARCHAR(300)))) || CAST(B.VDCLICLI_NUM AS VARCHAR(300))
INNER JOIN DBCONTROL3708005.CADVEN05 AS D ON A.CRMOVMOV_VEN=D.VDVENVEN_CODMOV