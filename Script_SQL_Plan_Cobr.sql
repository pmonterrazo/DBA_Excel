...
SELECT DISTINCT A.CRMOVMOV_NDUPL AS 'NUM. TITULO', A.CRMOVMOV_CCLI AS 'COD. CLIENTE', C.VDCLICLI_RAZAO50 AS 'RAZÃO SOCIAL', CAST(RIGHT(CAST(A.CRMOVMOV_DTE AS VARCHAR(300)),2) || '/' || SUBSTRING(CAST(A.CRMOVMOV_DTE AS VARCHAR(300)),5,2) || '/' || LEFT(CAST(A.CRMOVMOV_DTE AS VARCHAR(300)),4) AS VARCHAR(300)) AS 'DATA EMISSAO', CAST(RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) || '/' || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || '/' || LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) AS VARCHAR(300)) AS 'DATA VENCIMENTO', DAYS_BETWEEN(CAST(LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE),CURDATE()) AS DIAS, (CASE WHEN DAYS_BETWEEN(CAST(LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE),CURDATE()) > 0 THEN 'V' ELSE 'AV' END) AS 'V/AV',A.CRMOVMOV_VEN AS 'COD. VENDEDOR',A.CRMOVMOV_MOD AS 'TP. COBRANÇA', E.VDFATCFA_VALPRDORI AS 'VLR. ORIGINAL', A.CRMOVMOV_VALOR AS 'VLR. TITULO', (DAYS_BETWEEN(CAST(LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE),CURDATE()) * 0.002 * A.CRMOVMOV_VALOR) AS JUROS, ((DAYS_BETWEEN(CAST(LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE),CURDATE()) * 0.002 * A.CRMOVMOV_VALOR) + A.CRMOVMOV_VALOR) AS 'VLR. TOTAL', A.CRMOVMOV_SUPVD AS 'GA', C.VDCLICLI_CONTATO AS 'CONTATO', C.VDCLICLI_FONE AS 'TELEFONE 1', C.VDCLICLI_FONE2 AS 'TELEFONE 2', C.VDCLICLI_CEL1 AS 'TELEFONE 3', C.VDCLICLI_CEL2 AS 'TELEFONE 4'


FROM CADMOV01 AS A
INNER JOIN CADCLI01 AS C ON A.CRMOVMOV_CGC=C.VDCLICLI_CGC
-descontinuado
INNER JOIN CADVEN01 AS D ON A.CRMOVMOV_VEN=D.VDVENVEN_SIGLA
--
INNER JOIN NC211201 AS E ON A.CRMOVMOV_NPED=E.VDFATCFA_NPED
...
SELECT DISTINCT A.CRMOVMOV_NDUPL AS 'NUM.TITULO', A.CRMOVMOV_CCLI AS 'COD. CLIENTE', B.VDCLICLI_RAZAO50 AS 'RAZÃO SOCIAL', CAST(RIGHT(CAST(A.CRMOVMOV_DTE AS VARCHAR(300)),2) || '/' || SUBSTRING(CAST(A.CRMOVMOV_DTE AS VARCHAR(300)),5,2) || '/' || LEFT(CAST(A.CRMOVMOV_DTE AS VARCHAR(300)),4) AS VARCHAR(300)) AS 'DATA EMISSAO', CAST(RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) || '/' || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || '/' || LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) AS VARCHAR(300)) AS 'DATA VENCIMENTO', DAYS_BETWEEN(CAST(LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE),CURDATE()) AS DIAS, (CASE WHEN DAYS_BETWEEN(CAST(LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE),CURDATE()) > 0 THEN 'V' ELSE 'AV' END) AS 'V/AV', A.CRMOVMOV_MOD AS 'TP. COBRANÇA', C.VDPEDPPT_VLR_FCEM AS 'VLR. ORIGINAL',A.CRMOVMOV_VALOR AS 'VLR. TITULO', (DAYS_BETWEEN(CAST(LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE),CURDATE()) * 0.002 * A.CRMOVMOV_VALOR) AS JUROS, ((DAYS_BETWEEN(CAST(LEFT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),4) || SUBSTRING(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),5,2) || RIGHT(CAST(A.CRMOVMOV_DTV AS VARCHAR(300)),2) AS DATE),CURDATE()) * 0.002 * A.CRMOVMOV_VALOR) + A.CRMOVMOV_VALOR) AS 'VLR. TOTAL', A.CRMOVMOV_SUPVD AS 'GA', B.VDCLICLI_CONTATO AS 'CONTATO', B.VDCLICLI_FONE AS 'TELEFONE 1', B.VDCLICLI_FONE2 AS 'TELEFONE 2', B.VDCLICLI_CEL1 AS 'TELEFONE 3', B.VDCLICLI_CEL2 AS 'TELEFONE 4'

FROM CADMOV01 AS A 
INNER JOIN CADCLI01 AS B 
ON CAST(A.CRMOVMOV_CCLI AS VARCHAR(300))=CAST(VDCLICLI_REGI AS VARCHAR(300)) || REPEAT('0',4-LENGTH(CAST(VDCLICLI_NUM AS VARCHAR(300)))) || CAST(VDCLICLI_NUM AS VARCHAR(300))
INNER JOIN NPEDPT01 AS C
ON A.CRMOVMOV_NPED=VDPEDPPT_NPEDPT
LIMIT 10


CAST(LEFT(CAST(CURDATE() AS VARCHAR(300)),4) || SUBSTRING(CAST(CURDATE() AS VARCHAR(300)),5,2) ||  RIGHT(CAST(CURDATE() AS VARCHAR(300)),2) AS DATE)
