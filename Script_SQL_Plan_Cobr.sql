...
---ANALISAR E NÃO USAR COMO PADRÃO
...
CASE
   WHEN F.VDPEDIPE_CODR = 900089 THEN F.VDPEDIPE_QTDPRD 
END AS 'Falta',

CASE
   WHEN F.VDPEDIPE_CODR = 903025 THEN F.VDPEDIPE_QTDPRD 
END AS '903025',

CASE
   WHEN F.VDPEDIPE_CODR = 901781 THEN F.VDPEDIPE_QTDPRD 
END AS '901781',
...
CASE
   WHEN F.VDPEDIPE_CODR = 903131 THEN F.VDPEDIPE_QTDPRD 
END AS '903131',

CASE
   WHEN F.VDPEDIPE_CODR = 904121 THEN F.VDPEDIPE_QTDPRD 
END AS '904121',

CASE
   WHEN F.VDPEDIPE_CODR = 903126 THEN F.VDPEDIPE_QTDPRD 
END AS '903126',

CASE
   WHEN F.VDPEDIPE_CODR = 902795 THEN F.VDPEDIPE_QTDPRD 
END AS '902795',

CASE
   WHEN F.VDPEDIPE_CODR = 902780 THEN F.VDPEDIPE_QTDPRD 
END AS '902780',

CASE
   WHEN F.VDPEDIPE_CODR = 902815 THEN F.VDPEDIPE_QTDPRD 
END AS '902815',

CASE
   WHEN F.VDPEDIPE_CODR = 902809 THEN F.VDPEDIPE_QTDPRD 
END AS '902809',

CASE
   WHEN F.VDPEDIPE_CODR = 902791 THEN F.VDPEDIPE_QTDPRD 
END AS '902791',

CASE
   WHEN F.VDPEDIPE_CODR = 902800 THEN F.VDPEDIPE_QTDPRD 
END AS '902800',

CASE
   WHEN F.VDPEDIPE_CODR = 902813 THEN F.VDPEDIPE_QTDPRD 
END AS '902813',
CASE
   WHEN F.VDPEDIPE_CODR = 903188 THEN F.VDPEDIPE_QTDPRD 
END AS '903188',

CASE
   WHEN F.VDPEDIPE_CODR = 900023 THEN F.VDPEDIPE_QTDPRD 
END AS '900023',

CASE
   WHEN F.VDPEDIPE_CODR = 900032 THEN F.VDPEDIPE_QTDPRD 
END AS '900032',
...
WHERE CAST(LEFT(CAST(VDPEDCPE_NPED AS VARCHAR(300)),4) || SUBSTRING(CAST(VDPEDCPE_NPED AS VARCHAR(300)),5,2) || SUBSTRING(CAST(VDPEDCPE_NPED AS VARCHAR(300)),7,2) AS DATE) = CURDATE() AND G.VDCEVPEN_CODCLI=G.VDCEVPEN_CODCLI
