...
COUNT(G.VDCEVPEN_NPED) AS QUANTIDADE
...
GROUP BY A.VDPEDCPE_CODCLI, A.VDPEDCPE_NPED, B.VDCLICLI_RAZAO50,  A.VDPEDCPE_VEN_ORI_CLI, D.VDVENVEN_SUPVD, A.VDPEDCPE_TPCOBR, A.VDPEDCPE_CPG, E.VDCADPAG_DESCR, F.VDPEDIPE_OCOKD, A.VDPEDCPE_VLR_FCEM, C.CRMOVMOV_VALOR, C.CRMOVMOV_DTV, F.VDPEDIPE_CODR, F.VDPEDIPE_QTDPRD, G.VDCEVPEN_DTV, G.VDCEVPEN_NPED
